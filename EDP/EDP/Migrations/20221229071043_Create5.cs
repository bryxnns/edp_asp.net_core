        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    voucher_name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    percentage_off = table.Column<int>(type: "int", nullable: true),
                    user_id = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    min_spend = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
